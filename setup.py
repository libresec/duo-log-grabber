...
setup(
    ...
    license='GPLv3+',
    install_requires=['loggerglue', 'duo_client_python==2.1'],
    dependency_links=['https://github.com/duosecurity/duo_client_python/zipball/master#egg=duo_client_python-2.1'],
    classifiers=[
